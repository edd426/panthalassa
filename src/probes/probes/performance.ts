/**
 * P12 — throughput. A gate from day one.
 *
 ...
 * relaxed version, and it gates from the first integrated build precisely
 * because performance regressions are cheap to introduce and expensive to find
 * later.
 *
